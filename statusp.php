    ...
    <div id="apDiv8">
      <table width="1009" height="132" border="1">
        <tr>
         ...
         <?php
  $sql="select DISTINCT(usr_id),fullname,fname,address,contact,licence,date,status,approvedate,licencevalidity from permanent where usr_id=$user_id" ;
  $res=mysql_query($sql);
  while($row=mysql_fetch_array($res))
  {
  ?>
        <tr>
          <td>PL00<?php echo $row['usr_id']?></td>
         <td><?php echo $row['fullname'] ?></td>
          ...
          <td><a href="print_plr.php" target="_blank"><img src="printer.png" /></a> </td>
        </tr>
		<?php
      }
	  ?>
    ...
    <div id="apDiv7">Status of Permanent Licence</div>
  </div>
