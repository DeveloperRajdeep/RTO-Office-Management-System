...
<div id="apDiv1">
  ...
  <div id="apDiv10">**Note:Please bring two copies of passport size photo,voter_id card,vehicle orginal purchase copy for verification.Vehicle Registration will be issued after verifying your original documents.</div>
</div>
<div id="apDiv2">
  <div id="apDiv3">Vehicle Registration</div>
  <div id="apDiv4">
    <table width="441" height="486" border="0">
     <?php
  $sql="select DISTINCT(usr_id),vtype,carnum,modelnum,name,contact,address,approvedate,licencevalidity from vehicle_regis where usr_id=$user_id";
  $res=mysql_query($sql);
  while($row=mysql_fetch_array($res))
  {
  ?>
      <tr>
        <td width="216">Registration Id</td>
        <td width="10">:</td>
        <td width="203">REG00<?php echo $row['usr_id']?></td>
      </tr>
      <tr>
