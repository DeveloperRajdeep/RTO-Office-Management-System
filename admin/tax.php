...
<div id="apDiv1">
  <div id="apDiv6">
    <div id="apDiv8">
      <table width="958" height="162" border="1">
      
        <tr>
          <td width="71" height="72">Serial No.</td>
          <td width="81">User_Id</td>
          <td width="122">Vehicle Number</td>
          <td width="107">Vehicle Price</td>
          <td width="131"><p>Tax Pay Upto(in years)</p></td>
          <td width="99">Tax Amount</td>
          <td width="85">Status</td>
          <td width="85">Date of Pay</td>
          <td width="70">Approve </td>
          <td width="43">Deny</td>
        </tr>
        <?php
  $sql="select * from tax where status='processing'";
  $res=mysql_query($sql);
  $j=1;
  ...
  ?>
        <tr>
         ...
         <td><?php echo $row['date'] ?></td>
          <td><a href="approve3.php?a=<?php echo $row["tax_id"]?>"><img src="icon/tick.png"></a></td>
          <td><a href="deny3.php?b=<?php echo $row["tax_id"]?>"><img src="icon/delete.png"></a></td>
        </tr>
        <?php
      }
	  ?>
